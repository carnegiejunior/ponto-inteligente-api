...
import tech.metamaker.pontointeligente.api.repositories.LancamentoRepository;
...
public class LancamentoServiceTest {
	...
	public void testBuscarLancamentoPorFuncionarioId() {
		Page<Lancamento> lancamento = this.lancamentoService.buscaPorFuncionarioId(1L, new PageRequest(0,10));
		assertNotNull(lancamento);
	}

	@Test
	public void testBuscarLancamentoPorLancamentoId() {
